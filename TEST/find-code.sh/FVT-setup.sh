#!/bin/bash
# 	TEST/find-code.sh/FVT-setup.sh  4.1.79.976  2020-10-24T15:22:28.436186-05:00 (CDT)  https://github.com/BradleyA/markit  master  uadmin  five-rpi3b.cptx86.com 4.1.78-1-gafcd4f6  
